...
<body bgcolor=000000 text=FFFFFF style="background-image: url('/pihole/background.jpg'); background-repeat: no-repeat; background-size: cover;">
   <center>
      ...
      <a href="mailto:someone@example.com?subject=Domain%20Blocked&body=[sub]%0A%0ADO%20NOT%20CHANGE%20THE%20ABOVE%20MESSAGE" onclick="this.href =this.href.replace("[sub]",window.location)" target="_blank" rel=noopener noreferrer><button style="background-color:white; border-color:white">here</button></a>.<br>
